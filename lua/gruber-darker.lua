...
function M.load()
	...
	highlight("Search", { bg = colors.search }, config)
	...
	highlight("NotifyWARNBorder", { fg = colors.warning }, config)
	highlight("NotifyINFOBorder", { fg = colors.info }, config)
	highlight("NotifyDEBUGBorder", { fg = colors.hint }, config)
	highlight("NotifyTRACEBorder", { fg = colors.purple }, config)
	highlight("NotifyERRORIcon", { fg = colors.error }, config)
	highlight("NotifyWARNIcon", { fg = colors.warning }, config)
	highlight("NotifyINFOIcon", { fg = colors.info }, config)
	highlight("NotifyDEBUGIcon", { fg = colors.hint }, config)
	highlight("NotifyTRACEIcon", { fg = colors.purple }, config)
	highlight("NotifyERRORTitle", { fg = colors.error }, config)
	highlight("NotifyWARNTitle", { fg = colors.warning }, config)
